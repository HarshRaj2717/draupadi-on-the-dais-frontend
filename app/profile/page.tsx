function Profile() {
  return (
    <div className="text-4xl mt-10 mx-auto px-4 mr-4 text-center">
      <div className="flex justify-center gap-20 items-center">
        <div className="avatar flex justify-center items-center mr-4">
          <div className="w-64 h-64 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 flex justify-center items-center">
            <img src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" className="w-3/4 h-3/4 rounded-full" />
          </div>
        </div>
        <div className="flex justify-start items-start flex-col">
          ...
          <p className="text-xl">Mail:  <a href="https://mail.google.com/mail/u/0/#inbox" className="text-blue-500 hover:underline">Email</a></p>
        </div>
      </div>
      <div className="my-8">
        <label className="form-control">
          ...
          <div className="text-lg mb-6 textarea-bordered h-full p-4 mx-40 text-gray-700 placeholder-gray-500 placeholder-opacity-50 rounded-lg resize-none focus:ring focus:ring-primary focus:ring-opacity-50" >
            Mughda has over 20 years of experience in broadcast journalism. She is also an Autism Activist, Corporate Trainer & Mindfulness Coach. She runs a platform called 'Not The Different', in association with Bookosmia- a leading creative platform for children in India. Not That Different is India's first children-led movement in normalizing conversations around neurodiversity and push for inclusion.

            She continues to write for various portals and her on-screen assignments have been for both news television and websites. Her forte is storytelling and documentary writing.
          </div>
        </label>
      </div>
      <div className="mt-8 flex justify-center">
        <div className="w-full max-w-lg rounded-lg shadow-lg p-6 bg-white">
          <div className="text-xl font-semibold">
            <p className="mb-4">
              Mughda is a Chief Content Officer at Backstage - an interactive, audio social networking platform that is a powerful tool for brands and content creators to reach their audience via the audio medium.
            </p>
            <div className="flex items-center justify-center">
              <a href="https://www.linkedin.com/feed/" target="_blank" rel="noopener noreferrer" className="mr-4">
                <svg
              ...
              <a href="https://www.instagram.com/?hl=en" target="_blank" rel="noopener noreferrer" className="mr-4">
              <svg
              xmlns="http://www.w3.org/2000/svg"
